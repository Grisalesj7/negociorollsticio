...
const Cart = ({ 
  ...
  // ======================================================
  // VALIDAR HORARIO ANTES DE ENVIAR EL PEDIDO
  // ======================================================
  const handleCheckout = () => {
    const currentHour = new Date().getHours();

    // Horario de atención: 5:00 PM hasta 11:00 PM
    if (currentHour >= 17 && currentHour < 23) {
      // Si está abierto, continúa normalmente a WhatsApp
      sendToWhatsApp();
    } else {
      // Si está cerrado, NO abre WhatsApp
      alert(
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      {item.description ||
                        'Delicioso rollo preparado al instante con ingredientes frescos.'}
                    </span>
